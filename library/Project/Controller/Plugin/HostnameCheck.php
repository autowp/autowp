...
class Project_Controller_Plugin_HostnameCheck extends Zend_Controller_Plugin_Abstract
{
     ...
     * @var array
     */
    protected $_hostnameWhitelist = ['www.autowp.ru', 'ru.autowp.ru', 'en.autowp.ru', 'i.wheelsage.org', 'en.wheelsage.org', 'fr.wheelsage.org', 'www.wheelsage.org', 'wheelsage.org'];

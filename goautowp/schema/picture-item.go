...
const (
	...
	PictureItemTableAddUserIDColName         = "add_user_id"
	PictureItemTablePerspectiveUserIDColName = "perspective_user_id"
	PictureItemTableCreatedAtColName         = "created_at"
)
...
var (
	...
	PictureItemTableAddUserIDCol         = PictureItemTable.Col(PictureItemTableAddUserIDColName)
	PictureItemTablePerspectiveUserIDCol = PictureItemTable.Col(PictureItemTablePerspectiveUserIDColName)
	PictureItemTableCreatedAtCol         = PictureItemTable.Col(PictureItemTableCreatedAtColName)
)
...
type PictureItemRow struct {
	...
	AddUserID         sql.NullInt64   `db:"add_user_id"`
	PerspectiveUserID sql.NullInt64   `db:"perspective_user_id"`

...
func TestValueDateMustChangesWhenValueChanged(t *testing.T) {
	...
	require.NotEqual(t, value.GetUpdateTime().AsTime(), secondaryValue.GetUpdateTime().AsTime())
	...
	require.Equal(t, secondaryValue.GetUpdateTime().AsTime(), thirdValue.GetUpdateTime().AsTime())
}

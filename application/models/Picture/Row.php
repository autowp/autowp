...
class Picture_Row extends Project_Db_Table_Row
{
    ...
    protected function _postUpdate()
    {
        ...
        if (array_key_exists('brand_id', $this->_modifiedFields) && $this->_data['brand_id'] && in_array($this->_data['type'], [Picture::UNSORTED_TYPE_ID, Picture::MIXED_TYPE_ID, Picture::LOGO_TYPE_ID])) {
            $bpcRows[] = [
                'picture_id'    =>  $this->id,

                ...
                $.each(data, function(key, factory) {
                    if (factory.location) {
                        ...
                        if (self.items[factory.id]) {
                            ...
                            var position = new self.googlemaps.LatLng(factory.location.lat, factory.location.lng);
                            var marker = new self.googlemaps.Marker({
                                position: position,
                                map: self.map,
                                title: factory.name
                            });
                            ...
                            var infowindow = new self.googlemaps.InfoWindow({
                                content: info[0]
                            });
                            
                            self.googlemaps.event.addListener(marker, 'click', function() {

...
(function() {
  ...
  Node = (function() {
    function Node(gl1, width, height) {
      var floatExt;
      this.gl = gl1;
      this.width = width;
      this.height = height;
  ...
  Heights = (function() {
    function Heights(heatmap, gl1, width, height) {
      var i, j, ref;
  ...
  WebGLHeatmap = (function() {
    function WebGLHeatmap(arg) {
      var alphaEnd, alphaRange, alphaStart, error, getColorFun, gradientTexture, image, intensityToAlpha, output, quad, ref, ref1, textureGradient;
      ref = arg != null ? arg : {}, this.canvas = ref.canvas, this.width = ref.width, this.height = ref.height, intensityToAlpha = ref.intensityToAlpha, gradientTexture = ref.gradientTexture, alphaRange = ref.alphaRange;
      if (!this.canvas) {
      ...
      if (intensityToAlpha) {
        ref1 = alphaRange != null ? alphaRange : [0, 1], alphaStart = ref1[0], alphaEnd = ref1[1];

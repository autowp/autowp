 ...
 */
const LISTENER_MAP_PROP_ = 'closure_lm_' + ((Math.random() * 1e6) | 0);
 ...
 */
export enum CaptureSimulationMode {
  /**
 ...
 *     this is ON.
 */
const CAPTURE_SIMULATION_MODE = goog.define('goog.events.CAPTURE_SIMULATION_MODE', 2);
 ...
 */
export function listen<T, EVENTOBJ>(
  src: EventTarget | Listenable,
  type: string | Array<string> | EventId<EVENTOBJ> | Array<EventId<EVENTOBJ>>,
  listener: ((this: T, obj: EVENTOBJ) => ?) | { handleEvent: (e: any) => any } | null,
 ...
 * @suppress {strictMissingProperties} Added to tighten compiler checks
 */
function listen_<EVENTOBJ>(
  src: EventTarget,
  type: string | EventId<EVENTOBJ>,
  listener: Function,
  callOnce: boolean,
  opt_options: (boolean | AddEventListenerOptions),
  opt_handler: Object): ListenableKey {
  'use strict';
  if (!type) {
 ...
 * @suppress {strictMissingProperties} Added to tighten compiler checks
 */
export function listenOnce<T, EVENTOBJ>(
  src: EventTarget | Listenable,
  type: string | Array<string> | EventId<EVENTOBJ> | Array<EventId<EVENTOBJ>>,
  listener: ((this: T, obj: EVENTOBJ) => any) | { handleEvent: (any) => any } | null,
  opt_options: boolean | AddEventListenerOptions,
  opt_handler: T): Key {
  'use strict';
  if (Array.isArray(type)) {
 ...
 * @template T
 */
export function listenWithWrapper<T>(
  src: EventTarget | Listenable,
  wrapper: EventWrapper,
  listener: (this: T, a: any) => any | { handleEvent: (a: any) => any } | null,
  opt_capt: boolean,
  opt_handler: T) {
  'use strict';
...
export function unlisten(
  src: EventTarget | Listenable,
  type: string | Array<string> | EventId<EVENTOBJ> | Array<EventId<EVENTOBJ>>,
  listener: ((e: any) => any) | { handleEvent: (a: any) => any } | null,
 ...
 * @suppress {strictMissingProperties} Added to tighten compiler checks
 */
export function unlistenByKey(key: Key): boolean {
  'use strict';
 ...
 * @param {Object=} opt_handler Element in whose scope to call the listener.
 */
export function unlistenWithWrapper(
  src: EventTarget | Listenable,
  wrapper: EventWrapper,
 ...
 */
export function removeAll(obj: Object | undefined, opt_type: string | EventId): number {
  'use strict';
 ...
 */
function getListeners(obj: Object, type: string | EventId, capture: boolean): Array<!Listener> {
  'use strict';
  if (Listenable.isImplementedBy(obj)) {
 ...
 * @suppress {strictMissingProperties} Added to tighten compiler checks
 */
export function getListener<EVENTOBJ>(
  src: EventTarget | Listenable,
  type: string | EventId<EVENTOBJ>,
  listener: ((e: EVENTOBJ) => any) | { handleEvent: (e: any) => any } | null,
  opt_capt: boolean,
  opt_handler: Object
) {
  'use strict';
 ...
 * @suppress {strictMissingProperties} Added to tighten compiler checks
 */
export function hasListener(obj: EventTarget | Listenable, opt_type: string | EventId, opt_capture: boolean): boolean {
  'use strict';
  if (Listenable.isImplementedBy(obj)) {
 ...
 * @private
 */
function getOnString_(type: string): string {
  'use strict';
 ...
 */
export function fireListeners(obj: Object, type: string | EventId, capture: boolean, eventObject: Object): boolean {
  'use strict';
  if (Listenable.isImplementedBy(obj)) {
 ...
 * @private
 */
function fireListeners_(obj: Object, type: string | EventId, capture: boolean, eventObject: Object): boolean {
  'use strict';
  /** @type {boolean} */
  var retval = true;
 ...
 * @suppress {strictMissingProperties} Added to tighten compiler checks
 */
export function fireListener(listener: Listener, eventObject: Object)
 ...
 *     true.
 */
export function dispatchEvent(src: Listenable, e: EventLike): boolean {
  'use strict';
  assert(
 ...
 */
export function protectBrowserEventEntryPoint  (errorHandler: goog.debug.ErrorHandler) {
  'use strict';
  handleBrowserEvent_ =
 ...
 * @private
 */
function handleBrowserEvent_  (listener: Listener, opt_evt: Event): any {
  'use strict';
  if (listener.removed) {
    return true;
  }
 ...
 * @private
 */
 dunction isMarkedIeEvent_(e: Event): boolean {
  'use strict';
 ...
 * @private
 */
function getListenerMap_(src: EventTarget): ListenerMap {
  'use strict';
 ...
 * @suppress {strictMissingProperties} Added to tighten compiler checks
 */
export function wrapListener (listener: Object|Function) : Function{
  'use strict';

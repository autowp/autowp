...
import { listen, unlisten } from "./goog.events";
import {EventLike} from "./goog.events.EventLike";
import { assert } from "./goog.asserts";
import {ListenableKey} from "./goog.events.ListenableKey";
...
export class EventTarget extends Disposable implements Listenable {
   ...
   */
  private eventTargetListeners_ = new ListenerMap(this);
   ...
   * @private {!Object}
   */
  private actualEventTarget_: Object;
   ...
   */
  private parentEventTarget_: EventTarget|null = null;
   ...
   * @private
   */
  private static MAX_ANCESTORS_ = 1000;
  ...
  addEventListener (
    type: string|EventId,
    handler: (x: any) => any|{handleEvent:(x: any) => any}|null,
    opt_capture: boolean,
  ...
  removeEventListener = function(
    type: string|EventId, handler: (x:any)=>any|{handleEvent:(x: any) => any}|null, opt_capture: boolean, opt_handlerScope: Object) {
    'use strict';
   ...
   * @override
   */
  dispatchEvent = function(e: EventLike): boolean {
    'use strict';
  ...
  listen<SCOPE,EVENTOBJ>(
    ...
    listener: (this:SCOPE, event: EVENTOBJ)=>(boolean|undefined),
    opt_useCapture: boolean,
    opt_listenerScope: SCOPE): ListenableKey {
    'use strict';
    this.assertInitialized_();
   ...
   * @override
   */
  unlistenByKey(key: ListenableKey) {
    'use strict';
  ...
  fireListeners<EVENTOBJ>(
    type: string|EventId<EVENTOBJ>, capture: boolean, eventObject: EVENTOBJ): boolean {
    'use strict';
   ...
   * @override
   */
  getListeners<EVENTOBJ> (type: string|EventId<EVENTOBJ>, capture: boolean): ListenableKey {
    'use strict';
   ...
   * @override
   */
  hasListener<EVENTOBJ> (
    opt_type: string|EventId<EVENTOBJ>, opt_capture: boolean): boolean {
    'use strict';
   ...
   */
  setTargetForTesting (target: Object) {
    'use strict';
   ...
   * @private
   */
  private dispatchEventInternal_ (
    target: Object, e: Event|Object|string, opt_ancestorsTree: Listenable) {
    'use strict';

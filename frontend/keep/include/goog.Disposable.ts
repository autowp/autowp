...
import {IDisposable} from "./goog.disposable.IDisposable";
...
export class Disposable implements IDisposable {
  ...
  constructor() {
    ...
    if (Disposable.MONITORING_MODE != MonitoringMode.OFF) {
   ...
   */
  static MONITORING_MODE = 0;  //goog.define('goog.Disposable.MONITORING_MODE', 0);
   ...
   */
  static INCLUDE_STACK_ON_CREATION = true; // goog.define('goog.Disposable.INCLUDE_STACK_ON_CREATION', true);
   ...
   */
  static getUndisposedObjects = function () {
    'use strict';
    var ret = [];
   ...
   */
  static clearUndisposedObjects = function () {
    'use strict';
   ...
   */
  static isDisposed = function (obj) {
    'use strict';

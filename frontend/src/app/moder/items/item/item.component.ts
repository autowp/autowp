...
import {ModerItemsItemGdprComponent} from './gdpr/gdpr.component';
...
export class ModerItemsItemComponent {
  ...
  protected readonly gdprTab: Tab = {
    count: 0,
    visible: true,
  };
  ...
  protected readonly item$: Observable<Item> = combineLatest([this.#itemID, this.reloadItem$]).pipe(
    ...
    tap((item) => {
      ...
      this.gdprTab.visible = typeID === ItemType.ITEM_TYPE_PERSON;

...
const attrs: Record<string, string> = {
  ...
  'specs/attrs/95/96': $localize`from`,
  'specs/attrs/95/97': $localize`to`,
  'specs/attrs/95/104': $localize`model`,
  'specs/attrs/95/104/113': $localize`from`,
  'specs/attrs/95/104/114': $localize`to`,
  'specs/attrs/95/106': $localize`Sales`,
  'specs/attrs/95/106/109': $localize`from`,
  'specs/attrs/95/106/109/129': $localize`year`,
  'specs/attrs/95/106/109/130': $localize`month`,
  'specs/attrs/95/106/109/131': $localize`day`,
  'specs/attrs/95/106/111': $localize`to`,
  'specs/attrs/95/106/111/132': $localize`year`,
  'specs/attrs/95/106/111/133': $localize`month`,
  'specs/attrs/95/106/111/134': $localize`day`,
  'specs/attrs/95/107': $localize`auto show debut`,
  'specs/attrs/95/107/118': $localize`year`,
  'specs/attrs/95/107/119': $localize`month`,
  'specs/attrs/95/107/120': $localize`day`,
  'specs/attrs/95/108': $localize`production`,
  'specs/attrs/95/108/121': $localize`from`,
  'specs/attrs/95/108/121/123': $localize`year`,
  'specs/attrs/95/108/121/124': $localize`month`,
  'specs/attrs/95/108/121/125': $localize`day`,
  'specs/attrs/95/108/122': $localize`to`,
  'specs/attrs/95/108/122/126': $localize`year`,
  'specs/attrs/95/108/122/127': $localize`month`,
  'specs/attrs/95/108/122/128': $localize`day`,
  'specs/attrs/95/135': $localize`competition participation`,
  'specs/attrs/95/135/136': $localize`from`,
  'specs/attrs/95/135/137': $localize`to`,
...
const attrListOptions: Record<string, string> = {
  ...
  'specs/attrs/22/206/options/90': $localize`desmodromic valve timing`,
...
const achievementNames: Record<string, string> = {
  ...
  'picture-inspector-bronze': $localize`Bronze Picture Inspector`,
  'picture-inspector-silver': $localize`Silver Picture Inspector`,
  'picture-inspector-gold': $localize`Gold Picture Inspector`,
  'picture-inspector-platinum': $localize`Platinum Picture Inspector`,
  'picture-inspector-diamond': $localize`Diamond Picture Inspector`,
  'picture-buster-bronze': $localize`Bronze Picture Buster`,
  'picture-buster-silver': $localize`Silver Picture Buster`,
  'picture-buster-gold': $localize`Gold Picture Buster`,
  'picture-buster-platinum': $localize`Platinum Picture Buster`,
  'picture-buster-diamond': $localize`Diamond Picture Buster`,
  'spec-master-bronze': $localize`Bronze Spec Master`,
  'spec-master-silver': $localize`Silver Spec Master`,
  'spec-master-gold': $localize`Gold Spec Master`,
  'spec-master-platinum': $localize`Platinum Spec Master`,
  'spec-master-diamond': $localize`Diamond Spec Master`,
  'commentator-bronze': $localize`Bronze Commentator`,
  'commentator-silver': $localize`Silver Commentator`,
  'commentator-gold': $localize`Gold Commentator`,
  'commentator-platinum': $localize`Platinum Commentator`,
  'commentator-diamond': $localize`Diamond Commentator`,
...
const achievementDescriptions: Record<string, string> = {
  ...
  'picture-inspector-bronze': $localize`Awarded to moderators for personally accepting 100 pictures`,
  'picture-inspector-silver': $localize`Awarded to moderators for personally accepting 1,000 pictures`,
  'picture-inspector-gold': $localize`Awarded to moderators for personally accepting 10,000 pictures`,
  'picture-inspector-platinum': $localize`Awarded to moderators for personally accepting 100,000 pictures`,
  'picture-inspector-diamond': $localize`Awarded to moderators for personally accepting 1,000,000 pictures`,
  'picture-buster-bronze': $localize`Awarded to moderators for putting 100 pictures into the delete queue`,
  'picture-buster-silver': $localize`Awarded to moderators for putting 1,000 pictures into the delete queue`,
  'picture-buster-gold': $localize`Awarded to moderators for putting 10,000 pictures into the delete queue`,
  'picture-buster-platinum': $localize`Awarded to moderators for putting 100,000 pictures into the delete queue`,
  'picture-buster-diamond': $localize`Awarded to moderators for putting 1,000,000 pictures into the delete queue`,
  'spec-master-bronze': $localize`Awarded for personally contributing 100 attribute/spec values`,
  'spec-master-silver': $localize`Awarded for personally contributing 1,000 attribute/spec values`,
  'spec-master-gold': $localize`Awarded for personally contributing 10,000 attribute/spec values`,
  'spec-master-platinum': $localize`Awarded for personally contributing 100,000 attribute/spec values`,
  'spec-master-diamond': $localize`Awarded for personally contributing 1,000,000 attribute/spec values`,
  'commentator-bronze': $localize`Awarded for posting 100 comments`,
  'commentator-silver': $localize`Awarded for posting 1,000 comments`,
  'commentator-gold': $localize`Awarded for posting 10,000 comments`,
  'commentator-platinum': $localize`Awarded for posting 100,000 comments`,
  'commentator-diamond': $localize`Awarded for posting 1,000,000 comments`,

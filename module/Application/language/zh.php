<?php return array (
  ...
  'car-type/singleseater' => '单座型',
  'car-type-rp/singleseater' => '单座型',
...
前往[论坛](/forums/)可以讨论任何车型的任何话题。',
  ...
  'specs/attrs/dynamic/max-reverse-speed' => '最高时速',
  ...
  'forums/theme/german-cars/description' => '奥迪，宝马，梅赛德斯奔驰，欧宝，大众汽车，…',
  ...
  'test' => '测试是确定',
  'and' => '还有',
  'ng/%1$s-pictures' => '{count} 张图片',
  'ng/%1$s-items' => '{count} 项目',
  'ng/%1$s-comments' => '{count} 个评论',
...
[举报侵权行为](mailto:autowp@yandex.ru)',
  ...
  'item/type/7/add-sub-item' => '添加博物馆',
  'item/type/8/name' => '人',
  'item/type/8/name-plural' => '人',
  ...
  'upload/picture/cropped-to' => '剪切到 {resolution}',
...
现在您可以在"%s"中发表评论，建议使用清晰易懂的措辞表达您的看法：',
  ...
  'login/if-you-not-registered' => '如果您尚未注册[现在就可注册](/signup)!',
  ...
  'account/profile/select-photo' => '选择照片',
  'account/profile/photo/saved' => '已保存图片',
  'account/profile/photo/deleted' => '已删除图片',
  'account/profile/use-gravatar' => '您可以上传头像或使用[Gravatar](http://gravatar.com/)',
...
祝您幸福。',
  ...
  'users/registration/email-confirm-message' => '您好.
您已成功注册 %1$s
详细注册信息请见:
电子邮件地址: %2$s
...
诚挚的机器人 %4$s',
  ...
  'users/change-email/confirm-message' => '您好.
...
欲添加更多语言请参与 [翻译网站](https://github.com/autowp/autowp/tree/master/module/Application/language) 。',
  ...
  'moder/vehicle/catalogue/add-engine' => '添加引擎',
  'moder/vehicle/catalogue/add-category' => '添加组别',
  ...
  'moder/vehicle/catalogue/turbo-group-creator/vehicles' => '车型',
  'moder/vehicle/catalogue/add-brand' => '品牌 ...',
  'moder/vehicle/catalogue/add-brand-%s' => '品牌 %s',
  'ng/moder/vehicle/catalogue/add-brand-{brand}' => '品牌 {brand}',
  ...
  'moder/vehicle/pictures/turbo-group-creator' => '涡轮制造商',
...
Internal hyperlinks must be relative: ~~http://autowp.ru/bmw/~~ */bmw/*',
  ...
  'votings/voting/duration' => '从{from}至{to}期间的表决',
...
请不要忘记，',
  ...
  'restore-password/new-password/mail/body-%s' => '请在链接中输入新密码：%s
...
Reason: %s',
  ...
  'pm/user-%s-accept-replace-%s-%s' => '%s接受了替换申请%s to %s',
...
Where `ХХХХХХХХХХХХХХХХ` - code that will be sent to you via [the private messaging system](/account/messages?folder=system)',
  ...
  'forums/go-to-theme-name' => '前往主题 "{theme_name}"',
  'forums/go-to-theme' => '前往主题…',
  'forums/subforums' => '分论坛',
  'forums/last-message-in-topic-{topic_name}' => '最新回复 «{topic_name}»',

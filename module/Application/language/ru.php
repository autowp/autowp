...
Содержание сайта требует некоторых расходов.
...
Трансмиссия - не учитывется',
    ...
    'telegram/info' => 'Для вашего и нашего удобства мы создали "бота" в приложении [telegram](https://telegram.org/), который позволит улучшить ваш опыт взаимодействия с сайтом.

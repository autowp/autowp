<?php return array (
  ...
  'car-type/singleseater' => 'Монопост',
  'car-type-rp/singleseater' => 'Монопостов',
  'page/36/ng-name' => 'Технические характеристики',
  'catalogue/all-pictures-of' => 'Все изображения',
  'catalogue/sport-of' => 'Спорт',
  'catalogue/related-with' => 'Связанные с',
  'catalogue/other-pictures-of' => 'Другие изображения',
  'page/34/ng-name' => 'Все картинки {item}',
  'page/138/ng-name' => '{brand} {vehicle_type} в хронологическом порядке',
  'page/14/ng-name' => '{brand} в хронологическом порядке',
  'page/208/ng-name' => 'Двигатели {brand}',
  'page/37/ng-name' => 'Концепты и прототипы {brand}',
  'page/40/ng-name' => '{brand} Разное',
  'page/39/ng-name' => 'Логотипы {brand}',
  'page/15/ng-name' => 'Последние картинки {brand}',
  'perspective/chassis' => 'шасси',
  'brands/more-{count}-companies' => 'ещё {count, plural, one {{count} компания} few {{count} компании} many {{count} компаний} other {{count} компаний}}',
  'perspective/mockup' => 'макет',
  'catalogue/specifications-of-{name}' => 'Технические характеристики {name}',
  'moder/picture/edit-item' => 'Управление',
  'moder/picture/edit-picture-{id}' => 'Управление изображением №{id}',
  'page/141/ng-name' => 'Добавленные картинки {brand}',
  'page/28/ng-name' => 'Все картинки {group_name}',
  'page/102/ng-name' => 'Редактор характеристик {item_name}',
  'page/27/ng-name' => 'Технические характеристики {group_name}',
  'page/136/name' => 'О проекте',
  'page/136/title' => 'About us',
  '{count} vehicles' => '{count, plural, one {{count} автомобиль} few {{count} автомобиля} many {{count} автомобилей} other {{count} автомобилей}}',
  'select' => 'выбрать',
...
Поделиться своей радостью, обсудить наболевшее и просто поболтать об автомобилях и не только вы можете на нашем [форуме](/forums/).',
  ...
  'page/214/name' => 'Персоны',
  'persons/content-persons' => 'Персоны на фото',
  'mosts/most' => 'Самые',
  'persons/author-persons' => 'Авторы',
  'mosts/among' => 'среди',
  'upload/select-files' => 'Выбрать файлы',
  'upload/select-file' => 'Выбрать файл',
  'page/42/name' => 'Форумы',
  'page/213/name' => '%PERSON_NAME%',
  'page/51/name' => 'Новые изображения',
  'forums/theme/all-other/description' => 'Другие темы, не вошедшие в вышеперечисленные разделы',
  'inbox/all-brands' => 'Все марки',
  ...
  'and' => 'и',
  'ng/%1$s-pictures' => '{count, plural, one {{count} изображение} few {{count} изображения} many {{count} изображений} other {{count} изображений}}',
  'ng/%1$s-items' => '{count, plural, one {{count} единица данных} few {{count} единицы данных} many {{count} единиц данных} other {{count} единиц данных}}',
  'ng/%1$s-comments' => '{count, plural, one {{count} комментарий} few {{count} комментария} many {{count} комментариев} other {{count} комментариев}}',
  '{count} messages' => '{count, plural, one {{count} сообщение} few {{count} сообщения} many {{count} сообщений} other {{count} сообщений}}',
  '{topics} topics and {messages} messages' => '{topics, plural, one {{topics} тема} few {{topics} темы} many {{topics} тем} other {{topics} тем}} и {messages, plural, one {{messages} сообщение} few {{messages} сообщения} many {{messages} сообщений} other {{messages} сообщений}}',
  'year' => 'Год',
...
[Сообщить о нарушении авторских прав](mailto:autowp@yandex.ru)',
  ...
  'index/twins/description' => 'Вы знаете, что Daewoo Matiz имеет аж целых [шесть клонов](/twins/group/118812)? А знаете, что [общего у Lotus и Kia](/twins/group/118750)? Уверены, что вам покажется интересным этот раздел.',
  ...
  'ng/carlist/produced/%1$s' => '{count, plural, one {Произведена {count} единица} few {Произведено {count} единиц} many {Произведены {count} единицы} other {Произведены {count} единицы}}',
  'ng/carlist/produced-about/%1$s' => '{count, plural, one {Произведена примерно {count} единица} few {Произведено примерно {count} единиц} many {Произведены примерно {count} единицы} other {Произведены примерно {count} единицы}}',
  'carlist/specifications' => 'технические характеристики',
  'ng/carlist/designed by' => 'дизайн ',
  ...
  'upload/picture/cropped-to' => 'кадрировано {resolution}',
...
* Формат [JPEG](http://ru.wikipedia.org/wiki/JPEG) или [PNG](http://ru.wikipedia.org/wiki/PNG). Разрешение от: 640×360 до 10000×10000.
...
[Авторизируйтесь](/login) или [зарегистрируйтесь](/signup)',
  ...
  'comments/what-to-do-for-write-comments' => 'Чтобы иметь возможность оставлять комментарии, необходимо [зарегистрироваться или войти на сайт с помощью учётной записи в одной из социальных сетей](/login)',
...
Следующий комментарий вы сможете оставить в "%s", а пока у вас есть время уточнить ту мысль, которую вы хотели донести до общественности:',
  ...
  'login/if-you-lose-password' => 'Если вы забыли свой логин или пароль, вы можете воспользоваться [формой восстановления по e-mail](/restore-password)',
  'login/if-you-not-registered' => 'Если вы ещё не зарегистрированы на сайте, то можете [сделать это сейчас](/signup)',
  ...
  'account/profile/select-photo' => 'Выбрать фото',
  'account/profile/photo/saved' => 'Фотография сохранена',
  'account/profile/photo/deleted' => 'Фотография удалена',
  'account/profile/use-gravatar' => 'Вы можете загрузить своё фото или использовать сервис [Gravatar](http://gravatar.com/)',
  ...
  'account/email/text' => 'На этой странице вы можете изменить свой e-mail.
...
В знак благодарности мы предоставляем возможность [выбрать следующий автомобиль дня](/donate/vod)',
...
Перевод сайта на белорусский язык: %be-translator%

Перевод сайта на бразильский португальский: %pt-br-translator%
...
Принять участие в [переводе сайта](https://github.com/autowp/autowp/tree/master/module/Application/language) на другие языки.',
  ...
  'page/54/name' => 'Подтверждение e-mail',
  ...
  'moder/items/filter/name-exclude' => 'Название (исключить)',
  'moder/items/filter/item-type' => 'Тип',
  'moder/items/filter/vehicle-type' => 'Тип кузова',
  'moder/items/filter/vehicle-type/empty' => 'Не заполнено',
  'moder/items/filter/spec' => 'Рынок',
  'moder/items/filter/from-year' => 'Год начала',
  'moder/items/filter/to-year' => 'Год окончания',
  'moder/items/filter/parent' => 'Родитель',
  'moder/items/filter/category-exclude' => 'Категория (исключить)',
  'moder/items/filter/no-parents' => 'Без родителей',
  'moder/items/filter/order' => 'Сортировка',
  ...
  'moder/vehicle/catalogue/turbo-group-creator/text' => 'Инструмент для объединения нескольких автомобилей в под-модель',
  ...
  'moder/picture/picture-n' => 'Изображение №{id}',
...
Ссылки на внутрисайтовые страницы следует писать не полностью: ~~http://autowp.ru/bmw/~~ */bmw/*',
  ...
  'votings/voting/duration' => 'Опрос проводится с {from} по {to}',
...
Трансмиссия - не учитывется',
  ...
  'specs/attrs/15/208/209/options/114' => 'пружинная с толкающей штангой (Push-Rod)',
  ...
  'specs/attrs/15/208/209/options/124' => 'торсионная с толкающей штангой (Push-Rod)',
  ...
  'specs/attrs/15/217/218/options/161' => 'пружинная с толкающей штангой (Push-Rod)',
  ...
  'specs/attrs/15/217/218/options/175' => 'торсионная с толкающей штангой (Push-Rod)',
...
Код подтверждения будет отправлен вам через [систему личных сообщений](/account/messages?folder=system)
...
Здесь `ХХХХХХХХХХХХХХХХ` - код, который будет отправлен вам через [систему личных сообщений](/account/messages?folder=system)',
  ...
  'forums/go-to-theme-name' => 'Зайти в форум "{theme_name}"',
  'forums/go-to-theme' => 'Зайти в форум …',
  'forums/subforums' => 'Подфорумы',
  'forums/last-message-in-topic-{topic_name}' => 'Последнее сообщение в теме «{topic_name}»',
  ...
  'forums/register-to-post' => 'Чтобы иметь возможность создавать топики и отвечать в них, Вам необходимо [зарегистрироваться](/signup).',
...
Если Вы ещё не зарегистрированы, сделайте это сейчас [на странице регистрации](/signup).',
);
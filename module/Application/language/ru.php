...
[Авторизируйтесь](/ng2/login) или [зарегистрируйтесь](/ng/signup)',
  ...
  'comments/what-to-do-for-write-comments' => 'Чтобы иметь возможность оставлять комментарии, необходимо [зарегистрироваться или войти на сайт с помощью учётной записи в одной из социальных сетей](/ng2/login)',

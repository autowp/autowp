...
[Сообщить о нарушении авторских прав](mailto:autowp@yandex.ru)',
  ...
  'index/twins/description' => 'Вы знаете, что Daewoo Matiz имеет аж целых [шесть клонов](/ng/twins/group/118812)? А знаете, что [общего у Lotus и Kia](/ng/twins/group/118750)? Уверены, что вам покажется интересным этот раздел.',
...
Следующий комментарий вы сможете оставить в "%s", а пока у вас есть время уточнить ту мысль, которую вы хотели донести до общественности:',
  ...
  'login/if-you-lose-password' => 'Если вы забыли свой логин или пароль, вы можете воспользоваться [формой восстановления по e-mail](/ng/restore-password)',
  'login/if-you-not-registered' => 'Если вы ещё не зарегистрированы на сайте, то можете [сделать это сейчас](/ng/signup)',

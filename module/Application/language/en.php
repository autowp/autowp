<?php return array (
  ...
  'moder/picture/edit-item' => 'Edit item',
  'moder/picture/edit-picture-{id}' => 'Edit picture №{id}',
  'page/141/ng-name' => '{brand} pictures',
  'page/28/ng-name' => 'All pictures of {group_name}',
  'page/102/ng-name' => 'Specs editor of {item_name}',
  'page/27/ng-name' => 'Specifications of {group_name}',
...
[Report copyright violation](mailto:autowp@yandex.ru)',
  ...
  'most/economical/param' => 'fuel consumption in combined cycle',
  'most/gluttonous' => 'gluttonous',
  'most/gluttonous/param' => 'fuel consumption in combined cycle',
  ...
  'mosts/period/before1920' => 'before 1920',
  ...
  'upload/picture/cropped-to' => 'cropped to {resolution}',
...
Next, you can leave a comment in the "%s", as long as you have the time to clarify the idea you want to convey to the public:',
  ...
  'account/profile/select-photo' => 'Select photo',
  'account/profile/photo/saved' => 'Photo saved',
  'account/profile/photo/deleted' => 'Photo deleted',
  'account/profile/use-gravatar' => 'You can upload photo or use [Gravatar](http://gravatar.com/)',
...
Good luck.',
  ...
  'picture/on-that-factory-produced-vehicle' => 'This factory produced a car like this',
...
Take part in [the translation of the site](https://github.com/autowp/autowp/tree/master/module/Application/language) into other languages.',
  ...
  'moder/picture/filter/owner' => 'Uploaded by',
  ...
  'moder/vehicle/tabs/name' => 'Name and description',
  ...
  'ng/moder/vehicle/catalogue/add-brand-{brand}' => 'Brand {brand}',
  ...
  'moder/picture/picture-n' => 'Picture №{id}',
  ...
  'moder/picture/edit-and-repair/normalize' => 'Normalize',
...
Where `ХХХХХХХХХХХХХХХХ` - code that will be sent to you via [the private messaging system](/account/messages?folder=system)',
  ...
  'forums/go-to-theme-name' => 'Go to forum "{theme_name}"',
  'forums/go-to-theme' => 'Go to forum …',
  'forums/subforums' => 'Subforums',
  'forums/last-message-in-topic-{topic_name}' => 'Last message in topic «{topic_name}»',
  ...
  'forums/theme/french-cars' => 'French cars',

...
REPLACE INTO users (id, login, password, e_mail, name, last_online, role, last_ip, timezone)
values (1, 'test', '26cc2d23a03a8f07ed1e3d000a244636', 'test@example.com', 'tester', now(), 'user', inet6_aton('127.0.0.1'), 'Europe/Moscow');

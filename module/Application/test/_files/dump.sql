...
CREATE TABLE `brand_item` (
  ...
  KEY `item_id` (`item_id`),
  CONSTRAINT `brand_item_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `cars` (`id`),
...
CREATE TABLE `item_language` (
  ...
  CONSTRAINT `item_language_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `cars` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_parent` (
  ...
  CONSTRAINT `item_parent_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `cars` (`id`),
...
CREATE TABLE `log_events_cars` (
  ...
  CONSTRAINT `log_events_cars_fk1` FOREIGN KEY (`item_id`) REFERENCES `cars` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `modification` (
  ...
  KEY `item_id` (`item_id`),
  KEY `group_id` (`group_id`),
  CONSTRAINT `modification_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `cars` (`id`),
...
CREATE TABLE `of_day` (
  ...
  CONSTRAINT `FK_of_day_cars_id` FOREIGN KEY (`item_id`) REFERENCES `cars` (`id`) ON DELETE CASCADE,

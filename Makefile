...
build:
	...
	@cat ./vendor/twitter/bootstrap3/dist/js/bootstrap.js ./vendor/carhartl/jquery-cookie/jquery.cookie.js ./public_source/js/scripts.js ./public_source/js/moder.js > ./public_source/js/scripts.tmp.js
